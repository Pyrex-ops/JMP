        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (header.indexOf("GET /") >= 0) {
              ...
              client.println("<!DOCTYPE html> <html lang=\"it\"> <head> <meta charset=\"UTF-8\"> <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\"> <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"> <title>Imposta Wi-Fi</title> </head> <body> <h1>Wi-Fi</h1> Seleziona la rete Wi-Fi a cui collegare la scheda. <li>Uno</li> <li>Uno</li> <li>Uno</li> <li>Uno</li> <li>Uno</li> <li>Uno</li> <button>OK</button> </body> </html>");
            }
