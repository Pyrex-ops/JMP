...
/**
 * @brief Classe utilizzata per reindirizzare tutte le richieste al web server
 * ad un captive portal.
 *
 * Eredita la classe AsyncWebHandler e ha il compito di indicare tutte le
 * richieste come soddisfabili e soddisfarle tramite la redirezione al captive
 * portal.
 */
